...
D'autres clubs comme Alavés, Espanyol ou Celta Vigo dépassent également 40% de dépendance.
...
### **Question 13 : Quels sont les postes les plus recrutés l’été 2022 ? **

#### 🎯 Objectif:
Identifier les postes les plus ciblés par les clubs lors du mercato estival 2022, afin de dégager les priorités ou les tendances de recrutement (ex : renforcement offensif, stabilité défensive…).

#### 🧪 Hypothèse :
Les clubs ont principalement renforcé leur ligne offensive, avec une majorité de recrues jouant à des postes d’attaquants ou milieux offensifs.


```{r}
# On reprend la table transfers_2022 avec les postes traduits
library(treemap)

# Comptage du nombre de recrues par poste
postes_recrutement <- transfers_2022 %>%
  count(position) %>%
  arrange(desc(n))

# Treemap
treemap(postes_recrutement,
        index = "position",
        vSize = "n",
        type = "index",
        palette = "Set2",
        title = "Répartition des postes recrutés – Été 2022")

ggplot(postes_recrutement, aes(x = reorder(position, n), y = n)) +
  geom_col(fill = "#56B4E9") +
  coord_flip() +
  labs(
    title = "Nombre de joueurs recrutés par poste – Été 2022",
    x = "Poste",
    y = "Nombre de recrues"
  ) +
  theme_minimal()
...
### **Question 14 : Les investissements ont-ils amélioré les résultats sportifs ?**
