...
#### 🧠 Interprétation du graphique:
Le graphique montre les 15 premières ligues (hors 2e et 3e divisions) classées selon leur nombre de joueurs transférés.
On remarque que les 5 grands championnats sont en haut du classement comme prévu mais étonnemment la ligue turque ou même la ligue 2 française ont un nombre de transferts plus élevé que la ligue brésilienne. Cela peut provenir du fait qu'à cette année il y'a eu manque de talents provenants de ces pays.
