...
- 🔵 Les **attaquants** sont effectivement les plus valorisés, avec une moyenne largement supérieure aux autres postes. Cela confirme leur statut stratégique et commercial dans le football moderne.

- 🔵 Les **défenseurs centraux** arrivent en seconde position, ce qui valide notre hypothèse selon laquelle leur solidité et leur rareté renforcent leur valeur.

- 🔵 Les **ailiers droits** et **gauches** ont aussi une valeur notable, notamment en raison de profils rares et techniques (ex. : gauchers jouant à droite).

- 🔵 Les **milieux offensifs** sont un peu moins valorisés que prévu, ce qui peut s’expliquer par l’évolution des schémas tactiques où leur rôle est parfois absorbé par des ailiers ou des faux neufs.

- 🔵 Les **gardiens** sont clairement en bas du classement, confirmant qu’ils sont beaucoup moins valorisés sur le marché des transferts.

✅ **Conclusion** : L’hypothèse est **largement confirmée**. Les attaquants et défenseurs centraux dominent le marché, tandis que les gardiens sont nettement moins cotés.
...
#### 🎯 Objectif:
Analyser si le nombre d’expected goals (xG) réalisés par une équipe est corrélé avec son total de points en championnat. Cela permet de vérifier si produire beaucoup d’occasions de qualité est un bon indicateur de performance globale. Données utilisées : saison 2022-2023.
...
- 🔵 Les clubs **sans recrues** présentent des résultats très variables, avec une médiane proche de zéro, ce qui confirme qu’un manque de renfort ne permet pas de progresser de manière fiable.

- 🔵 Les clubs ayant recruté **1 à 3 joueurs** semblent légèrement décliner, peut-être faute de renforts suffisants.

- 🔵 Les clubs ayant recruté **4 à 6 joueurs** montrent en moyenne une **amélioration du classement**, ce qui **confirme notre hypothèse principale**.

- 🔵 En revanche, les clubs avec **7 recrues ou plus** ont une médiane légèrement négative et une très grande dispersion, ce qui va dans le sens d’un **manque de stabilité** ou d’un effet “trop de changements tue la cohérence”.
